...
CONTAINS
      ...
      DO ji = mi0(ki), mi1(ki)
         DO jj = mj0(kj), mj1(kj)
            ...
            IF ( kn .EQ. 2 ) THEN
               ...
               WRITE(numout,*) ' v_ice(i  ,j)  : ', v_ice(ji,jj)
               WRITE(numout,*) ' strength      : ', strength(ji,jj)
               WRITE(numout,*) ' dmgt          : ', dmgt(ji,jj)  !#bbm
               WRITE(numout,*) ' dmgf          : ', dmgf(ji,jj)  !#bbm
               WRITE(numout,*)
   ...
   SUBROUTINE ice_prt3D( cd_routine )
      ...
      CALL prt_ctl(tab2d_1=dmgt       , clinfo1= ' dmgt       :', mask1=tmask) !#bbm
      CALL prt_ctl(tab2d_1=dmgf       , clinfo1= ' dmgf       :', mask1=fmask) !#bbm
