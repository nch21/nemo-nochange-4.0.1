...
CONTAINS             
   ...
   SUBROUTINE usr_def_zgr(  ld_zco  , ld_zps  , ld_sco  , ld_isfcav,    &   ! type of vertical coordinate
	...
	!!self
      ...
      ! ------------------------------------
      CALL zgr_z( jpi, jpj, jpk, jpi-1, jpj-1, jpk-1, pdept_1d, pdepw_1d, pe3t_1d , pe3w_1d )   ! Reference z-coordinate system
      !
      CALL zgr_bot( z_bot ) 
      CALL zgr_msk_top_bot( jpi,jpj, jpk-1, k_top , k_bot, z_bot , pdept_1d  )                 ! masked top and bottom ocean t-level indices
      !
      ...
      CALL zgr_zps( jpi, jpj, jpk,jpi-1,jpj-1,jpk-1, pdept_1d, pdepw_1d, pe3t_1d, pe3w_1d,   &   ! in  : 1D reference vertical coordinate
         &          pdept   , pdepw   ,                     &   ! out : 3D t & w-points depth
         &          pe3t    , pe3u    , pe3v   , pe3f   ,   &   !       vertical scale factors
         &          pe3w    , pe3uw   , pe3vw           ,   &
         &          z_bot   , k_bot  )     !           -      -      -
