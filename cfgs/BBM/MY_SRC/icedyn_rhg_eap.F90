       ...
       !  write(*,*) 'eap 1'
         ...
         DO_2D( 0, 1, 0, 1 )   ! loop ends at jpi,jpj so that no lbc_lnk are needed for zs1 and zs2
          ...
          !  if(ji<6 .and. jj<6) write(*,*) 'eap 1.1',  zdelta(ji,jj), zp_delt(ji,jj),paniso_11(ji,jj), paniso_12(ji,jj)
            ...
            !   if(ji<6 .and. jj<6) write(*,*) 'zdtevp', zdtevp,'rdt_ice',rDt_ice, 'paniso_11', paniso_11(ji,jj), 'paniso_12', paniso_12(ji,jj), 'zmresult11', zmresult11, 'zmresult12', zmresult12, 'zstressptmp', zstressptmp, 'zstressmtmp', zstressmtmp, 'zstress12tmp', zstress12tmp(ji,jj), 'strength', strength(ji,jj)
